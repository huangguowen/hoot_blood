...
//index
$LANG['admin_site_title'] = '热血牛牛后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = '热血牛牛后台管理中心';
...
$LANG['between_1_to_20'] = '输入正确的用户ID';
...
$LANG['admin_setting'] = '代理设置';
$LANG['admin_manage'] = '代理管理';
$LANG['admin_add'] = '添加代理';
...
//自行增加
$LANG['panel'] = '首页';
$LANG['sys_setting'] = '用户管理';
//部分模块
$LANG['site_management'] = '用户列表';
$LANG['pay'] = '充值管理';
$LANG['payments'] = '充值记录';
$LANG['diamond'] = '砖石消费记录';
$LANG['coins'] = '金币消费记录';
$LANG['fangka'] = '房卡消费记录';
$LANG['sys_notice'] = '公告发布';
$LANG['notice'] = '公告管理';
$LANG['agent'] = '代理推广';
...
$LANG['copyright'] = "CopyRight 2017 甬润科技（杭州）网络科技有限公司 HANGZHOU TEAM";
$LANG['code'] = "邀请码";
$LANG['between_4_to_20'] = "4-20位";
$LANG['add_agent'] = "一级代理查询";
?>