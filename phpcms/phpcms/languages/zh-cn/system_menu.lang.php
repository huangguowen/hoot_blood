...
$LANG['ipbanned'] = 'IP禁止';
$LANG['module_manage'] = '消耗记录管理';
$LANG['module_list'] = '消耗记录列表';
...
$LANG['payment_add'] = '支付消耗记录添加';
$LANG['payment_delete'] = '支付消耗记录卸载';
$LANG['payment_edit'] = '支付消耗记录编辑';
...
$LANG['my_agent'] = '我的代理';
$LANG['my_vip'] = '我的会员';
$LANG['Billing details'] = '账单明细';
$LANG['agent_edit'] = '代理编辑';
$LANG['agent_edit_n'] = '代理列表(未注册)';
$LANG['代理列表'] = '代理列表';
$LANG['agent_management'] = '代理管理 ';
$LANG['agent'] = '代理管理';
$LANG['data_statistics'] = '数据统计';
$LANG['pay'] = '充值管理';
$LANG['settlement_summary'] = '结算汇总';
$LANG['ettlement_details'] = '结算明细';
$LANG['shujutongji'] = '数据统计';
$LANG['site_management'] = '玩家列表';
$LANG['fanli'] = '返利比例';
$LANG['duihuan'] = '兑换记录';
$LANG['zengsong'] = '赠送管理';
$LANG['add_agent'] = '添加代理';
$LANG['add_agent2'] = '添加代理';
$LANG['add_agent3'] = '添加代理';
?>