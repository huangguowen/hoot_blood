...
$(function(){
	...
	$("#extern_id").formValidator({onshow:"<?php echo L('input').L('extern_id')?>",onfocus:"<?php echo L('extern_id').L('between_1_to_20')?>"}).inputValidator({min:1,max:20,onerror:"<?php echo L('extern_id').L('between_1_to_20')?>"}).ajaxValidator({
	    type : "get",
		url : "",
...
<tr>
<td width="80">玩家ID</td> 
<td><input type="test" name="info[extern_id]"  class="input-text" id="extern_id"></input></td>
</tr>
...
<!-- <td>自己的推广邀请码</td>
<td>
<input type="text" name="info[code]" value="" class="input-text" id="code"></input>
</td>
<tr id="join_code_id">
<td>要加入的邀请码</td>
<td>
<input type="text" name="info[join_code]" value="<?php echo $this->db->get_code_foruserid($_SESSION['userid']); ?>" class="input-text" id="join_code" disabled="disabled"></input>（无需填写）
</td>
</tr> -->
...
<input type="hidden" name="info[email]" value="test@qq.com" class="input-text" id="email" size="30"></input>

<tr>
<td>手机号(后台登陆账号)</td>
<td>
<input type="text" name="info[phone]" value="" class="input-text" id="phone" size="30"></input>
</td>
</tr>
...
<td>开户行</td>
<td>
<!-- <input type="text" name="info[bank_place]" value="" class="input-text" id="bank_place" size="30"></input> -->
						<select id="cmbProvince" name="info[province]"></select>  
                        <select id="cmbCity" name="info[city]"></select>  
                        <select id="cmbArea" name="info[area]"></select>  
